...
public class BarangForm extends javax.swing.JInternalFrame {
    ...
    private DefaultTableModel tableBarang; 
    ...
    public BarangForm() {
        ...
        this.tableBarang = (DefaultTableModel) tblBarang.getModel();
    ...
    public void loadBarang() {
        ...
        for (int i = 0; i < items.length(); i++) {
            ...
            String createdAt = Lib.timeAgo(item.getString("created_at"));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        TableRowSorter<TableModel> sorter = new TableRowSorter<>(tblBarang.getModel());
